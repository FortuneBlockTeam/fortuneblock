...
export BUILDER_IMAGE_NAME="fortuneblock-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export USE_SHELL="/bin/fortuneblock"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_FORTUNEBLOCK_DEBUG"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  export RUN_INTEGRATIONTESTS=true
