...
rm -f src/config/fortuneblock-config.h
...
rm -rf test_bitcoin.coverage/ fortuneblock-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_fortuneblock
clean_exe src/fortuneblock-cli
clean_exe src/fortuneblockd
clean_exe src/fortuneblock-gtest
clean_exe src/test/test_fortuneblock
clean_exe src/test/test_fortuneblock_fuzzy
clean_exe src/qt/fortuneblock-qt
clean_exe src/qt/test/test_fortuneblock-qt
...
clean_dep . src/config/fortuneblock-config.h.in
