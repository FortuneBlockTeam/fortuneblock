# Support for Output Descriptors in Fortuneblock Core

Since Fortuneblock Core v0.17 with Future Lock Transactions, 
...
existing Fortuneblock Core wallets, a convenience function `combo` is
...
All RPCs in Fortuneblock Core will include the checksum in their output. Only
