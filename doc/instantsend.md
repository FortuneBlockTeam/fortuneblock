...
This mechanism has been integrated into Bitcore-Node-Fortuneblock which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FortuneBlockTeam/insight-api-fortuneblock#web-socket-api](https://github.com/FortuneBlockTeam/insight-api-fortuneblock#web-socket-api)
* API: [https://github.com/FortuneBlockTeam/insight-api-fortuneblock#instantsend-transactions](https://github.com/FortuneBlockTeam/insight-api-fortuneblock#instantsend-transactions)
