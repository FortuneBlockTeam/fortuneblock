...
git clone https://github.com/FortuneBlockTeam/gitian.sigs.git
```
...
```bash
    ...
    From https://github.com/FortuneBlockTeam/fortuneblock
...
cd /some/root/path/
git clone https://github.com/FortuneBlockTeam/fortuneblock-detached-sigs.git
...
[fortuneblock/gitian.sigs](https://github.com/FortuneBlockTeam/gitian.sigs/) repository, or if that's not possible to create a pull
request.
