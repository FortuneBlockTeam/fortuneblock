...
* fortuneblock.conf: contains configuration settings for fortuneblockd or fortuneblock-qt
* fortuneblockd.pid: stores the process id of fortuneblockd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by fortuneblockd or fortuneblock-qt
