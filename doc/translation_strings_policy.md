...
This document provides guidelines for internationalization of the Fortuneblock Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fortuneblock_en.ts` remains unchanged.
