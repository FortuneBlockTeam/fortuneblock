...
from test_framework.test_framework import FortuneblockTestFramework
...
class LLMQChainLocksTest(FortuneblockTestFramework):
    def set_test_params(self):
        self.set_fortuneblock_test_params(6, 5, fast_dip3_enforcement=True)
