...
"""Verify that starting fortuneblockd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fortuneblockd with -h for help text")
        ...
        self.log.info("Start fortuneblockd with -version for version information")
        ...
        self.log.info("Start fortuneblockd with -fakearg  to make sure it does not start")
