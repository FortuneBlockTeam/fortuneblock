...
# Objects that map to fortuneblockd objects, which can be serialized/deserialized
...
class msg_headers():
    ...
    def deserialize(self, f):
        # comment in fortuneblockd indicates these should be deserialized as blocks
