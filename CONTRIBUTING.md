Contributing to Fortuneblock Core
============================

The Fortuneblock Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to fortuneblock-qt
...
[Translation Process](https://github.com/FortuneBlockTeam/fortuneblock/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Fortuneblock Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fortuneblock
Network Protocol consensus changes.

Whether a pull request is merged into Fortuneblock Core rests with the project merge
...
Patches that change Fortuneblock consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fortuneblock consensus, it must have been
...
The review process is normally fairly responsive on the Fortuneblock Core repository, however
...
The project leader is the release manager for each Fortuneblock Core release.
