...
void BitcoinGUI::createActions() {
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Fortuneblock address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Fortuneblock address").arg(strCoinJoinName));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fortuneblock addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(
            tr("Verify messages to ensure they were signed with specified Fortuneblock addresses"));
    ...
    openAction->setStatusTip(tr("Open a fortuneblock: URI"));
    ...
    showHelpMessageAction->setStatusTip(
            tr("Show the %1 help message to get a list with possible Fortuneblock command-line options").arg(
                    PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fortuneblock network", "", count));
    } else {
