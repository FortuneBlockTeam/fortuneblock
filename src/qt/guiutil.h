...
/** Utility functions used by the Fortuneblock Qt UI.
 */
namespace GUIUtil {
    ...
    // Parse "fortuneblock:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load fortuneblock specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a fortuneblock specific theme is activated (light/dark).*/
