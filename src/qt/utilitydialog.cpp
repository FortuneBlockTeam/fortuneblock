...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: fortuneblock-qt [command-line options]                     \n";
...
All the Fortuneblock in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 FTB, 0.01 FTB, 0.1 FTB, 1 FTB and 10 FTB -- sort of like the paper money you use every day.</li> \
