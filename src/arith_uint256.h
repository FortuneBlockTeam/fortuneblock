...
#ifndef FORTUNEBLOCK_ARITH_UINT256_H
#define FORTUNEBLOCK_ARITH_UINT256_H
...
public:
     ...
     *
     * Fortuneblock only uses this "compact" format for encoding difficulty
...
#endif // FORTUNEBLOCK_ARITH_UINT256_H
