...
/** Connect all fortuneblockd signal handlers */
void noui_connect();

/** Suppress all fortuneblockd signal handlers. Used to suppress output during test runs that produce expected error. */
void noui_suppress();
