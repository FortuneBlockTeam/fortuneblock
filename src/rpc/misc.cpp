...
static UniValue validateaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"validateaddress",
               "\nReturn information about the given fortuneblock address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Fortuneblock address to validate"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    RPCHelpMan{"verifymessage",
               "\nVerify a signed message\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Fortuneblock address to use for the signature."},
...
UniValue getaddressutxos(const JSONRPCRequest &request) {
    RPCHelpMan{
            ...
            "\nReturns all unspent outputs for an address (requires addressindex to be enabled).\n",
            {
                ...
                {"asset", RPCArg::Type::STR, /* default */ "FTB", "Get UTXOs for a particular asset instead of FTB ('*' for all assets).",}
            },
            {
                RPCResult{"For FTB",
                    RPCResult::Type::ARR, "", "",
...
UniValue getaddressdeltas(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressdeltas",
               "\nReturns all changes for an address (requires addressindex to be enabled).\n",
               {
                    ...
                    {"asset", RPCArg::Type::STR, /* default */ "FTB", "Get all changes for a particular asset instead of FTB.",}
...
static UniValue getaddressbalance(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressbalance",
               "\nReturns the balance for an address(es) (requires addressindex to be enabled).\n",
        {
            ...
            {"asset", RPCArg::Type::STR, /* default */ "FTB", "Get balance for a particular asset instead of FTB. (\"*\" for all assets)"},
        },
        {
            RPCResult{"For FTB",
                RPCResult::Type::OBJ, "", "",
...
UniValue logging(const JSONRPCRequest &request) {
    RPCHelpMan{"logging",
               ...
               "The valid logging categories are: " + LogInstance().LogCategoriesString() + "\n"
                                                                                            ...
                                                                                            "  - \"fortuneblock\" activates all Fortuneblock-specific categories at once.\n"
...
UniValue echo(const JSONRPCRequest &request) {
    RPCHelpMan{"echo|echojson ...",
               ...
               "fortuneblock-cli and the GUI. There is no server-side difference.",
               {},
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                ...
                /* Fortuneblock features */
                {"fortuneblock",    "mnsync",                 &mnsync,                 {}},
                {"fortuneblock",    "spork",                  &spork,                  {"arg0",       "value"}},
