...
//! Interface for the src/evo part of a fortuneblock node (fortuneblockd process).
    class EVO {
    public:
        virtual ~EVO() {}
...
//! Interface for the src/llmq part of a fortuneblock node (fortuneblockd process).
    class LLMQ {
    public:
        virtual ~LLMQ() {}
...
//! Interface for the src/smartnode part of a fortuneblock node (fortuneblockd process).
    namespace Smartnode {
        class Sync {
        public:
            virtual ~Sync() {}
...
//! Top-level interface for a fortuneblock node (fortuneblockd process).
    class Node {
    public:
        virtual ~Node() {}
