...
/**
 * future fee share for smartnode, miner and luckyone
 */
    struct FutureRewardShare {
        ...
        FutureRewardShare() : smartnode(0), miner(0), fortune(0) {}

        FutureRewardShare(float _smartnode, float _miner, float _fortune) : smartnode(_smartnode), miner(_miner),
                                                                            fortune(_fortune) {}
    };
 ...
 */
    struct Params {
        ...
        FortunePayment nFortunePayment;
